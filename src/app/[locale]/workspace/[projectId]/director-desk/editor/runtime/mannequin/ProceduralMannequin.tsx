...
import {
  ...
  getSingleAxisRotation,
} from './mannequinPose'
import { getPosePreset } from './mannequinPosePresets'
...
export function ProceduralMannequin({
  ...
  // preset provides defaults; explicit poseControls override preset values
  const controls: Record<string, number> = {
    ...getPosePreset(posePresetId),
    ...(poseControls ?? {}),
  }
