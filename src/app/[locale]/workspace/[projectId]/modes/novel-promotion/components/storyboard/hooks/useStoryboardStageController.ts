...
export function useStoryboardStageController({
  ...
  return {
    ...
    submittingStoryboardIds, submittingPanelImageIds, selectingCandidateIds, compositingStoryboardIds,
    editingPanel, setEditingPanel, modifyingPanels, isDownloadingImages, previewImage, setPreviewImage,
    regeneratePanelImage, regenerateAllPanelsIndividually, createAiStoryboardImage, createCompositedStoryboardImage, selectPanelCandidate, selectPanelCandidateIndex,
