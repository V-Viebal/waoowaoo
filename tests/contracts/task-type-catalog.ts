...
const TASK_TYPE_OWNER_MAP = {
  ...
  [TASK_TYPE.AI_GRID_VIDEO_PROMPT]: 'tests/unit/workers/grid-video-prompt-rewrite-handler.test.ts',
  ...
  [TASK_TYPE.CHARACTER_VOICE_RECOMMEND]: 'tests/unit/billing/character-voice-recommend-billing.test.ts',
  ...
  [TASK_TYPE.EDITOR_AI_SMART_CUT]: 'tests/integration/api/editor-ai-routes.test.ts',
