...
const ROUTE_FILES = [
  'src/app/api/admin/config-center/art-styles/[styleId]/generate-preview/route.ts',
  'src/app/api/admin/config-center/art-styles/[styleId]/route.ts',
  'src/app/api/admin/config-center/art-styles/generate-prompt/route.ts',
  'src/app/api/admin/config-center/art-styles/route.ts',
  'src/app/api/admin/config-center/prompts/[promptId]/route.ts',
  ...
  'src/app/api/art-styles/generate-preview/route.ts',
  'src/app/api/art-styles/generate-prompt/route.ts',
  ...
  'src/app/api/novel-promotion/[projectId]/bailian-voices/route.ts',
  ...
  'src/app/api/novel-promotion/[projectId]/character/[characterId]/recommend-voice-instruct/route.ts',
...
function resolveContractGroup(routeFile: string): RouteContractGroup {
  ...
  if (routeFile.startsWith('src/app/api/novel-promotion/[projectId]/editor/ai/')) {
